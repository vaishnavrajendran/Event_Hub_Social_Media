...
const BoostPost = () => {
  ...
  const dataFromChild = (data) => {
    ...
    if(data == 100000) setAmount(2*120);
      ...
      <div class="min-w-screen min-h-screen bg-gray-50 py-5">
        <div class="px-5">
          ...
          <div class="mb-5 text-gray-400">
            <a
              href="/home"
              class="focus:outline-none hover:underline text-grey-500"
            >
              Home
            </a>{" "}
          ...
          <div class="w-full">
            <div class="-mx-3 md:flex items-start">
              <div class="px-3 md:w-7/12 lg:pr-10">
                <div class="mb-6 pb-6 border-b border-gray-200 text-gray-800">
                  <div class="w-full flex mb-3 items-center">
                    <div class="flex-grow">
                      <span class="ml-2 font-semibold uppercase text-gray-600">
                        Your post will be reached over {childData === "" ? 50000 : childData  } accounts
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div class="w-full mx-auto text-gray-800 font-light mb-6 border-b border-gray-200 pb-6">
                  <div class="w-full flex items-center">
                    ...
                    <div class="flex-grow pl-3">
                      ...
                      <SelectBoost onData = {dataFromChild} />
                    </div>
                    <div>
                ...
                <div class="mb-6 pb-6 border-b border-gray-200 md:border-none text-gray-800 text-xl">
                  <div class="w-full flex items-center">
                    ...
                    <div class="pl-3">
                      ...
                      <span class="font-semibold">${amount+tax}</span>
                    </div>
                  </div>
                </div>
                <div class="flex justify-center bg-blue-500 text-white py-2 px-4 rounded">
              ...
              <div class="px-3 md:w-5/12">
                ...
                {purchase && <Stripe postId={state.postID} amount={amount+tax} />}
              </div>
            </div>
          </div>
        </div>
